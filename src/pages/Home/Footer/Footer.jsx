    ...
    return (
      ...
      <div className="container px-6 py-12 mx-auto">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
              ...
              <div>
                  <p className="font-semibold text-black  dark:text-white">Quick Link</p>
  
                  <div className="flex flex-col text-black items-start mt-5 space-y-2">
          ...
          <div className="flex items-center justify-between">
              ...
              <div className="flex text-black -mx-2">
